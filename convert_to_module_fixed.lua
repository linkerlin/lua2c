...
-- 转换 lua2c 生成的 C 代码为 Lua 模块（修复版）
-- 用法: lua convert_to_module_fixed.lua input.c output.c module_name
...
if not input_file or not output_file or not module_name then
  print("用法: lua convert_to_module_fixed.lua input.c output.c module_name")
  os.exit(1)
end
